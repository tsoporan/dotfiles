...
awful.util.tagnames = { "[dev]", "[dev2]", "[dev3]", "[web]"}
...
globalkeys = awful.util.table.join(
    ...
    awful.key({ altkey }, "p", function() os.execute("scrot -d 5 -c") end,
    ...
    awful.key({ altkey }, "Up",
        function ()
            os.execute(string.format("pamixer -i 10", beautiful.volume.channel))
            beautiful.volume.update()
        end,
        {description = "volume up", group = "hotkeys"}),
    awful.key({ altkey }, "Down",
        function ()
            os.execute(string.format("pamixer -d 10", beautiful.volume.channel))
            beautiful.volume.update()
        end,
